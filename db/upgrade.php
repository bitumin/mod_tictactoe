...
function xmldb_tictactoe_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the tictactoe
     * iself has been upgraded.
     *
     * For each upgrade block, the file tictactoe/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to tictactoe.
        ...
        // Define field intro to be added to tictactoe.
        $table = new xmldb_table('tictactoe');
        ...
        // Define field introformat to be added to tictactoe.
        $table = new xmldb_table('tictactoe');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'tictactoe');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to tictactoe.
        $table = new xmldb_table('tictactoe');
        ...
        // Define field timemodified to be added to tictactoe.
        $table = new xmldb_table('tictactoe');
        ...
        // Define index course (not unique) to be added to tictactoe.
        $table = new xmldb_table('tictactoe');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'tictactoe');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'tictactoe');
    }
